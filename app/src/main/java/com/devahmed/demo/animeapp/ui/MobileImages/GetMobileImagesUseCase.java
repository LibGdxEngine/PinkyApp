...
public class GetMobileImagesUseCase extends BaseObservableMvcView<GetMobileImagesUseCase.Listener> {
    private final String FIREBASE_PATH = "MobileImages";
    ...
    public GetMobileImagesUseCase(FirebaseDatabase database) {
