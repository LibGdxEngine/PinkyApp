...
public class MobileImagesAdapter extends RecyclerView.Adapter<MobileImagesAdapter.ViewHolder> {
    ...
    private int [] placeHolders = {R.color.pl0,
            ...
            R.color.pl20, };
    public MobileImagesAdapter(List<Image> ImagesList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_mobile_image, parent, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            imageView = view.findViewById(R.id.mobileImage);
        }
    }
